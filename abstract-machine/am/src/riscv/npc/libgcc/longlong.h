...
#define COUNT_LEADING_ZEROS_0 32
#if defined(_ARCH_PPC) || defined(__powerpc__) || defined(__POWERPC__) || defined(__ppc__) || (defined(PPC) && !defined(CPU_FAMILY)) /* gcc 2.7.x GNU&SysV */ \
    || (defined(PPC) && defined(CPU_FAMILY)                                                                                          /* VxWorks */            \
        && CPU_FAMILY == PPC)
#define umul_ppmm(ph, pl, m0, m1)                              \
  do {                                                         \
  ...
  do {                                                                       \
    ...
    __asm__(                                                                 \
        ...
        : "%r"(__m0),                                                        \
          "r"(__m1)                                                          \
        : "r2");                                                             \
    (ph) += ((((SItype)__m0 >> 31) & __m1) + (((SItype)__m1 >> 31) & __m0)); \
  } while (0)
#define UMUL_TIME 20
...
#if defined(__sparc__) && !defined(__arch64__) && !defined(__sparcv9) && W_TYPE_SIZE == 32
#define add_ssaaaa(sh, sl, ah, al, bh, bl)    \
...
#if ((defined(__sparc__) && defined(__arch64__)) || defined(__sparcv9)) && W_TYPE_SIZE == 64
#define add_ssaaaa(sh, sl, ah, al, bh, bl) \
  do {                                     \
    UDItype __carry = 0;                   \
...
#define umul_ppmm(xh, xl, m0, m1)                                            \
  do {                                                                       \
    ...
    (xh) = __xx.__i.__h;                                                     \
    (xl) = __xx.__i.__l;                                                     \
    (xh) += ((((SItype)__m0 >> 31) & __m1) + (((SItype)__m1 >> 31) & __m0)); \
  } while (0)
#define sdiv_qrnnd(q, r, n1, n0, d)    \
  do {                                 \
    union {                            \
...
#define umul_ppmm(xh, xl, m0, m1)                                                    \
  do {                                                                               \
    ...
    (xh) = __xx.__i.__h;                                                             \
    (xl) = __xx.__i.__l;                                                             \
    (xh) += ((((signed int)__m0 >> 15) & __m1) + (((signed int)__m1 >> 15) & __m0)); \
  } while (0)
#endif /* __z8000__ */
...
#define umul_ppmm(w1, w0, u, v)                                                                      \
  do {                                                                                               \
    ...
    (w1) = __w1 + (-(__xm0 >> (W_TYPE_SIZE - 1)) & __xm1) + (-(__xm1 >> (W_TYPE_SIZE - 1)) & __xm0); \
  } while (0)
#endif
